                ...
                if(this.headnumber==0){
                    global.currentnode = null;
                        ...
                        if(this.score>=this.threestar){
                              ...
                              globalstarnum.starnum11=3;
                              return;
                        }
                        if(this.score>=this.twostar){
                            this.star2.active=true;
                            if( globalstarnum.starnum11<2)
                            globalstarnum.starnum11=2;
                            return;
                      }
                      if( globalstarnum.starnum11<1)
                      globalstarnum.starnum11=1;
