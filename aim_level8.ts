            ...
            if(this.headnumber==0){
                global.currentnode = null;
                    ...
                    if(this.score>=this.threestar){
                          ...
                          globalstarnum.starnum8=3;
                          return;
                    }
                    if(this.score>=this.twostar){
                        this.star2.active=true;
                        if( globalstarnum.starnum8<2)
                        globalstarnum.starnum8=2;
                        return;
                  }
                  if( globalstarnum.starnum8<1)
                  globalstarnum.starnum8=1;
