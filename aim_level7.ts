        ...
        this.headnumber-=1;
            ...
            if(this.headnumber==0){
                    ...
                    if(this.score>=this.threestar){
                          ...
                          globalstarnum.starnum7=3;
                          
                          return;
                    }
                    if(this.score>=this.twostar){
                        this.star2.active=true;
                        if( globalstarnum.starnum7<2)
                        globalstarnum.starnum7=2;
                         
                        return;
                  }
                  if( globalstarnum.starnum7<1)
                  globalstarnum.starnum7=1;
