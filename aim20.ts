                ...
                if(this.headnumber==0){
                    global.currentnode = null;
                        ...
                        if(this.score>=this.threestar){
                              ...
                              globalstarnum.starnum20=3;
                              return;
                        }
                        if(this.score>=this.twostar){
                            this.star2.active=true;
                            if( globalstarnum.starnum20<2)
                            globalstarnum.starnum20=2;
                            return;
                      }
                      if( globalstarnum.starnum20<1)
                      globalstarnum.starnum20=1;
                        this.star1.active=true;
                        return;
                }
        }
        onnextbuttonClick(){
            global4.canvasname4 = 'canvas21';
