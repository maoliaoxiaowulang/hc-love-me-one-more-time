            ...
            if(this.headnumber==0){
                global.currentnode = null;
                    ...
                    if(this.score>=this.threestar){
                          ...
                          globalstarnum.starnum12=3;
                          return;
                    }
                    if(this.score>=this.twostar){
                        this.star2.active=true;
                        if( globalstarnum.starnum12<2)
                        globalstarnum.starnum12=2;
                        return;
                  }
                 
                  if( globalstarnum.starnum12<1)
                   globalstarnum.starnum12=1;
