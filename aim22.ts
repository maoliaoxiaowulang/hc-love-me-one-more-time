                ...
                if(this.headnumber==0){
                    global.currentnode = null;
                        ...
                        if(this.score>=this.threestar){
                              ...
                              globalstarnum.starnum22=3;
                              return;
                        }
                        if(this.score>=this.twostar){
                            this.star2.active=true;
                            if( globalstarnum.starnum22<2)
                            globalstarnum.starnum22=2;
                            return;
                      }
                      if( globalstarnum.starnum22<1)
                      globalstarnum.starnum22=1;
                        this.star1.active=true;
                        return;
                }
        }
        onnextbuttonClick(){
            global4.canvasname4 = 'canvas23';
