...
export class aim extends Component {
    ...
    private showeff(pos: Vec3) {    
        ...
        if (angelout.equals(this.alignToGrid(v3(this.mine.worldPosition.x-this.mapnode.worldPosition.x,this.mine.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            this.score-=4;
            this.mine.active=true;
            return;
        }
        if (angelout.equals(this.alignToGrid(v3(this.mine2.worldPosition.x-this.mapnode.worldPosition.x,this.mine2.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            this.score-=4;
            this.mine2.active=true;
            return;
        }
        if (angelout.equals(this.alignToGrid(v3(this.mine3.worldPosition.x-this.mapnode.worldPosition.x,this.mine3.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            this.score-=4;
            this.mine3.active=true;
            return;
        }
        if (angelout.equals(this.alignToGrid(v3(this.mine4.worldPosition.x-this.mapnode.worldPosition.x,this.mine4.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            this.score-=4;
            this.mine4.active=true;
            return;
        }
        if (angelout.equals(this.alignToGrid(v3(this.mine5.worldPosition.x-this.mapnode.worldPosition.x,this.mine5.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            this.score-=4;
            this.mine5.active=true;
            return;
        }
        if (angelout.equals(this.alignToGrid(v3(this.mine6.worldPosition.x-this.mapnode.worldPosition.x,this.mine6.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            this.score-=4;
            this.mine6.active=true;
            return;
        }
        if (angelout.equals(this.alignToGrid(v3(this.mine7.worldPosition.x-this.mapnode.worldPosition.x,this.mine7.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            this.score-=4;
            this.mine7.active=true;
            return;
        }
    ...
    updateScoreDisplay(){
        if(this.scoreLabel){this.score-=1;
            this.scoreLabel.string=`${this.score}`;
        }
    }
    onnextbuttonClick(){
        global2.canvasname2 = 'canvas10';
            ...
            if(this.headnumber==0){
                global.currentnode = null;
                    ...
                    if(this.score>=this.threestar){
                          ...
                          globalstarnum.starnum9=3;
                          return;
                    }
                    if(this.score>=this.twostar){
                        this.star2.active=true;
                        if( globalstarnum.starnum9<2)
                        globalstarnum.starnum9=2;
                        return;
                  }
                  if( globalstarnum.starnum9<1)
                  globalstarnum.starnum9=1;
