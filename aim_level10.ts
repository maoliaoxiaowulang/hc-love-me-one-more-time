...
export class aim extends Component {
        ...
        @property(Node)
        planebody7: Node = null;
        @property(Node)
        planehead7: Node= null;

        @property(Node)
        planebody8: Node = null;
        @property(Node)
        planehead8: Node= null;

        @property(Node)
        planebody9: Node = null;
        @property(Node)
        planehead9: Node= null;
    ...
    private showeff(pos: Vec3) {    
        ...
        if (angelout.equals(this.alignToGrid(v3(this.planehead7.worldPosition.x-this.mapnode.worldPosition.x,this.planehead7.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            const headnode = instantiate(this.explosion);
            this.canvas.addChild(headnode);
            headnode.setWorldPosition(out);
            headnode.position=this.alignToGrid(headnode.position)
        ...
        if (angelout.equals(this.alignToGrid(v3(this.planehead8.worldPosition.x-this.mapnode.worldPosition.x,this.planehead8.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            const headnode = instantiate(this.explosion);
            this.canvas.addChild(headnode);
            headnode.setWorldPosition(out);
            headnode.position=this.alignToGrid(headnode.position)
        ...
        if (angelout.equals(this.alignToGrid(v3(this.planehead9.worldPosition.x-this.mapnode.worldPosition.x,this.planehead9.worldPosition.y-this.mapnode.worldPosition.y,0)))){
            const headnode = instantiate(this.explosion);
            this.canvas.addChild(headnode);
            headnode.setWorldPosition(out);
            headnode.position=this.alignToGrid(headnode.position)
        ...
        for (const element of this.planebody7.children){
            if(angelout.equals(this.alignToGrid(v3(element.worldPosition.x-this.mapnode.worldPosition.x,element.worldPosition.y-this.mapnode.worldPosition.y,0)))){
                const bodynode = instantiate(this.hit);
                this.canvas.addChild(bodynode);
                bodynode.setWorldPosition(out);
        ...
        for (const element of this.planebody8.children){
            if(angelout.equals(this.alignToGrid(v3(element.worldPosition.x-this.mapnode.worldPosition.x,element.worldPosition.y-this.mapnode.worldPosition.y,0)))){
                const bodynode = instantiate(this.hit);
                this.canvas.addChild(bodynode);
                bodynode.setWorldPosition(out);
        ...
        for (const element of this.planebody9.children){
            if(angelout.equals(this.alignToGrid(v3(element.worldPosition.x-this.mapnode.worldPosition.x,element.worldPosition.y-this.mapnode.worldPosition.y,0)))){
                const bodynode = instantiate(this.hit);
                this.canvas.addChild(bodynode);
                bodynode.setWorldPosition(out);
            ...
            if(this.headnumber==0){
                global.currentnode = null;
                    ...
                    if(this.score>=this.threestar){
                          ...
                          globalstarnum.starnum10=3;
                          return;
                    }
                    if(this.score>=this.twostar){
                        this.star2.active=true;
                        if( globalstarnum.starnum10<2)
                        globalstarnum.starnum10=2;
                        return;
                  }
                  if( globalstarnum.starnum10<1)
                  globalstarnum.starnum10=1;
