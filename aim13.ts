                ...
                if(this.headnumber==0){
                    global.currentnode = null;
                        ...
                        if(this.score>=this.threestar){
                              ...
                              globalstarnum.starnum13=3;
                              return;
                        }
                        if(this.score>=this.twostar){
                            this.star2.active=true;
                            if( globalstarnum.starnum13<2)
                            globalstarnum.starnum13=2;
                            return;
                      }
                      if( globalstarnum.starnum13<1)
                      globalstarnum.starnum13=1;
                        this.star1.active=true;
                        return;
                }
        }
        onnextbuttonClick(){
            global3.canvasname3 = 'canvas14';
