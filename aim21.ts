                ...
                if(this.headnumber==0){
                    global.currentnode = null;
                        ...
                        if(this.score>=this.threestar){
                              ...
                              globalstarnum.starnum21=3;
                              return;
                        }
                        if(this.score>=this.twostar){
                            this.star2.active=true;
                            if( globalstarnum.starnum21<2)
                            globalstarnum.starnum21=2;
                            return;
                      }
                      if( globalstarnum.starnum21<1)
                      globalstarnum.starnum21=1;
                        this.star1.active=true;
                        return;
                }
        }
        onnextbuttonClick(){
            global4.canvasname4 = 'canvas22';
